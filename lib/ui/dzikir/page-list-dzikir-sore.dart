...
import 'package:flutter_app_baarakallah/model/list-dzikir-sore.dart';



class ListDzikirSore extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Dzikir Sore', style: TextStyle(color: Colors.black),),
      ),
...
class _ListDzikirState extends State<ListDzikir> {
  ...
  List<DzikirSore> _data = itemList;
  @override
  Widget build(BuildContext context) {
  ...
  Widget _dzikirPanel() {
    return ExpansionPanelList(
      ...
      children: _data.map<ExpansionPanel>((DzikirSore item) {
